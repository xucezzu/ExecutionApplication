...
public interface IPasswordBiz {
     ...
     * @param userNewAgainPassword  用户再次输入新密码
     * @param resetPasswordListener 重置结果监听
     */
    void resetUserPassword(String userMail, String userNewPassword, String userNewAgainPassword, OnPasswordListener.OnResetPasswordListener resetPasswordListener);
}
